...
import static com.example.appprototipe.R.id.action_comprar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.appprototipe.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case action_comprar:
                Toast.makeText(this, "SHopping Option Comming soon", Toast.LENGTH_SHORT).show();
                break;
